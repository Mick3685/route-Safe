            ...
            <tbody>
                @forelse ($amendes as $amende)
                    <tr>
                        ...
                        <td>
                            <kkiapay-widget amount="{{ $amende->montant }}" key="5621aef028e311efb086931beae204b3"
                                callback="{{ Route('kkiapay.callback') }}" sandbox="true">
                                <!-- Assurez-vous de définir sandbox="false" en production -->
                            </kkiapay-widget>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="text-center">Aucune amende reçue.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
